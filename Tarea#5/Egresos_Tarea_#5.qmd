...
El análisis de los **egresos estatales** es central para evaluar la asignación del gasto público, la priorización de políticas públicas y la capacidad de los gobiernos estatales para financiar servicios y proyectos. Comprender la estructura del gasto estatal permite detectar desequilibrios, rigideces presupuestales y oportunidades para mejorar la eficiencia en el uso de recursos.
...
|------------------------------------|:-----------------------------------|
| **Gasto Corriente** | Sueldos y salarios, materiales y suministros, servicios generales, transferencias corrientes |
| **Gasto de Capital** | Inversión pública, adquisición de activos, infraestructura |
| **Resto de Egresos** | Servicio de la deuda, participaciones y otros pasivos, variaciones en disponibles |
