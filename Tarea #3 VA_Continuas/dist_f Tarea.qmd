...
hist(muestras_F, probability = TRUE, breaks = 30, main = "Histograma de muestras de F(1, n)",
     xlab = "x", col = "red", border = "black")
curve(df(x, 1, n), add = TRUE, col = "green", lwd = 2)
legend("topright", legend = c("PDF teórica F(1, n)"), col = "red", lwd = 2)
...
hist(muestras_F_ba, probability = TRUE, breaks = 30, main = "Histograma de muestras de F(b, a)",
     xlab = "x", col = "green", border = "red")
curve(df(x, b, a), add = TRUE, col = "purple", lwd = 2)
...
curve(df(x, a, b), add = TRUE, col = "red", lwd = 2)
legend("topright", legend = c("PDF teórica F(a, b)"), col = "red", lwd = 2)
