...
#municipios_Zacatecas <- st_read("C:/Users/fidel/Documentos/Estadistica Aplicada"/data/32mun.shp", options = "ENCODING=LATIN1", quiet = TRUE)
...
#datos_total <- read_csv(Estadistica Aplicada/data-32/cpv_valor_32.csv", na = c("ND"))
datos_total <- read_csv("data/cpv_valor_32.csv.zip", na = c("ND"))
...
ggplot(datos) +
  ...
  labs(
    title = "Derechohabientes IMSS (%) de los Municipios de Zacatecas",
    caption = "Fuente: INEGI - Marco Geoestadístico"
  ) +
  theme_void() +
  theme(
...
ggplot(data = datos, aes(sample = porcentaje_de_la_poblacion_derechohabiente_en_el_imss)) +
    ...
    labs(title = "Gráfico Q-Q para Normalidad",
    subtitle = "Derechohabientes IMSS (%) - Zacatecas") +
    theme_bw()+
    theme(
    legend.title = element_text(size=13, face="bold"),
    legend.text = element_text(size=13),
...
ggplot(datos) +
  ...
  labs(
    title = "Población de los Municipios de   Zacatecas",
    caption = "Fuente: INEGI - Marco Geoestadístico"
  ) +
  theme_void() +
  theme(
